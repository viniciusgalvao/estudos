...
angular.module("listaTelefonica",["ngMessages","serialGenerator","ui","ngRoute"]),angular.module("listaTelefonica").config(["$httpProvider",function(t){t.interceptors.push("timestampInterceptor"),t.interceptors.push("errorInterceptor"),t.interceptors.push("loadingInterceptor")}]),angular.module("listaTelefonica").config(["$routeProvider",function(t){t.when("/contatos",{templateUrl:"view/contatos.html",controller:"listaTelefonicaCtrl",resolve:{contatos:["contatosAPI",function(t){return t.getContatos()}]}}),t.when("/novoContato",{templateUrl:"view/novoContato.html",controller:"novoContatoCtrl",resolve:{operadoras:["operadorasAPI",function(t){return t.getOperadoras()}]}}),t.when("/detalhesContato/:id",{templateUrl:"view/detalhesContato.html",controller:"detalhesContatoCtrl",resolve:{contato:["contatosAPI","$route",function(t,e){return t.getContato(e.current.params.id)}]}}),t.when("/error",{templateUrl:"view/error.html"}),t.otherwise({redirectTo:"/contatos"})}]),angular.module("listaTelefonica").config(["serialGeneratorProvider",function(t){t.setLength(5)}]),angular.module("listaTelefonica").controller("detalhesContatoCtrl",["$scope","contato",function(t,e){t.contato=e.data}]),angular.module("listaTelefonica").controller("listaTelefonicaCtrl",["$scope","contatos","serialGenerator",function(t,e,o){t.app="Lista Telefonica",t.contatos=e.data,t.hasContatoSelecionado=!1;var n=function(){r(t.contatos),a(t.contatos)},r=function(t){t.forEach(function(t){t.operadora.precoComImposto=i(t.operadora.preco)})},a=function(t){t.forEach(function(t){t.serial=o.generate()})};t.apagarContatos=function(e){t.contatos=e.filter(function(t){if(!t.selecionado)return t}),t.verificarContatoSelecionado(t.contatos)},t.verificarContatoSelecionado=function(e){t.hasContatoSelecionado=e.some(function(t){return t.selecionado})},t.ordenarPor=function(e){t.criterioDeOrdenacao=e,t.direcaoDaOrdenacao=!t.direcaoDaOrdenacao};var i=function(t){var e=1.2;return t*e};t.reset=function(){t.contatos=angular.copy(t.contatos)},n()}]),angular.module("listaTelefonica").controller("novoContatoCtrl",["$scope","contatosAPI","serialGenerator","$location","operadoras",function(t,e,o,n,r){t.operadoras=r.data,t.adicionarContato=function(r){r.serial=o.generate(),r.data=new Date,e.saveContato(r).success(function(e){delete t.contato,t.contatoForm.$setPristine(),n.path("/contatos")})}}]),angular.module("listaTelefonica").directive("uiAlert",function(){return{templateUrl:"view/alert.html",replace:!0,restrict:"E",scope:{title:"@"},transclude:!0}}),angular.module("listaTelefonica").directive("uiDate",["$filter",function(t){return{require:"ngModel",link:function(e,o,n,r){var a=function(t){return t=t.replace(/[^0-9]+/g,""),t.length>2&&(t=t.substring(0,2)+"/"+t.substring(2)),t.length>5&&(t=t.substring(0,5)+"/"+t.substring(5,9)),t};o.bind("keyup",function(){r.$setViewValue(a(r.$viewValue)),r.$render()}),r.$parsers.push(function(t){if(10===t.length){var e=t.split("/");return new Date(e[2],e[1]-1,e[0]).getTime()}}),r.$formatters.push(function(e){return t("date")(e,"dd/MM/yyyy")})}}}]),angular.module("listaTelefonica").filter("ellipsis",function(){return function(t,e){var o=t.length<=e?t:t.substring(0,e||2)+"...";return o}}),angular.module("listaTelefonica").filter("name",function(){return function(t){var e=t.split(" "),o=e.map(function(t){return/(da|de)/.test(t.toLowerCase())?t.toLowerCase():t.charAt(0).toUpperCase()+t.substring(1).toLowerCase()});return o.join(" ")}}),angular.module("listaTelefonica").factory("errorInterceptor",["$q","$location",function(t,e){return{responseError:function(o){return 404==o.status&&e.path("/error"),t.reject(o)}}}]),angular.module("listaTelefonica").factory("loadingInterceptor",["$q","$rootScope","$timeout",function(t,e,o){return{request:function(t){return e.loading=!0,t},requestError:function(o){return e.loading=!1,t.reject(o)},response:function(t){return o(function(){e.loading=!1},500),t},responseError:function(o){return e.loading=!1,t.reject(o)}}}]),angular.module("listaTelefonica").factory("timestampInterceptor",function(){return{request:function(t){var e=t.url,o=(new Date).getTime();return e.indexOf("view")>-1?t:(t.url=e+"?timestamp="+o,t)}}}),angular.module("listaTelefonica").factory("contatosAPI",["$http","config",function(t,e){var o=function(){return t.get(e.baseUrl+"/contatos")},n=function(o){return t.get(e.baseUrl+"/contatos/"+o)},r=function(o){return t.post(e.baseUrl+"/contatos",o)};return{getContatos:o,getContato:n,saveContato:r}}]),angular.module("listaTelefonica").service("operadorasAPI",["$http","config",function(t,e){this.getOperadoras=function(){return t.get(e.baseUrl+"/operadoras")}}]),angular.module("listaTelefonica").value("config",{baseUrl:"http://localhost:3412"});